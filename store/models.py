...
class Product(models.Model):
    ...
    thumbnail1 = models.ImageField(upload_to='static/imgs/product/%Y/%m/%d', default=True, null=True, blank=True)
    thumbnail2 = models.ImageField(upload_to='static/imgs/product/%Y/%m/%d', default=True, null=True, blank=True)
    thumbnail3 = models.ImageField(upload_to='static/imgs/product/%Y/%m/%d', default=True, null=True, blank=True)
